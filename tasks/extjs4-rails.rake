...
namespace :'extjs4-rails' do
  IMAGES_DIR = 'vendor/assets/images/extjs4-rails'
  JAVASCRIPTS_DIR = 'vendor/assets/javascripts/extjs4-rails'
  STYLESHEETS_DIR = 'vendor/assets/stylesheets/extjs4-rails'
...
Rake.application.tasks_in_scope(%w(extjs4-rails install)).each do |t|
